...
`.trim();
  ...
  const snackUrl = `https://snack.expo.dev/embedded?platform=${platform}&name=${encodeURIComponent(appName || 'WebView App')}&description=${encodeURIComponent('Generated by Web2App Converter')}&code=${encodedCode}&dependencies=${encodeURIComponent(dependencies)}&preview=true&theme=dark`;
